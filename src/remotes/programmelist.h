...
#ifndef PROGRAMMELIST_H
#define PROGRAMMELIST_H

#include "request.h"

class Programme;

class ProgrammeList : public QObject
{
    Q_OBJECT
...
public:
    explicit ProgrammeList(QObject *parent = 0) :
        QObject(parent)
    {
    }
    ...
    Q_INVOKABLE virtual Programme* at(int i) const = 0;

public Q_SLOTS:
    virtual void clear() = 0;
    virtual void reload(const QString &) = 0;
